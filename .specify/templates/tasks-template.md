...
**Note**: This project does NOT include automated testing per constitutional mandate. All quality assurance is performed through code review and manual verification.
...
**Manual Verification**: [How to verify this story works - specific steps to manually test]
...
# Then launch service/endpoint work:
Task: "Implement [Service] in src/services/[service].py"
Task: "Implement [endpoint/feature] in src/[location]/[file].py"
```
...
- Each user story should be independently completable and verifiable through manual testing
